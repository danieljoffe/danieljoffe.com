...
| **P3 — route boundaries**                        | ⏭ Phase 4+   | 27    | Better served by Playwright e2e — wyrdfold-e2e project is currently empty; scoped for Phase 5.                                                                                                                                                                                                                                           |
| **P3 — presentational subcomponents**            | ⏭ Next batch | ~26   | Per user direction: P3 sweep happens in the next batch after this commit.                                                                                                                                                                                                                                                                |
