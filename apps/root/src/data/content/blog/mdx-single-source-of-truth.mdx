export const metadata = {
  ...
  cover: {
    ...
    src: '/images/covers/mdx-single-source-of-truth.webp',
  },
};
...
Project structured data collapsed from 104 lines into the same pattern. Adding a new blog post or project no longer needs a structured data entry at all; the generator picks it up automatically from the MDX metadata.
