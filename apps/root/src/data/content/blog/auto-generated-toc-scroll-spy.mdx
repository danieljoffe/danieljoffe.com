export const metadata = {
  ...
  date: '2026-04-04',
  excerpt:
    'How I built a responsive, accessible table of contents that extracts headings from rendered MDX, tracks reading position with IntersectionObserver, and adapts between a sticky sidebar and a mobile bottom sheet.',
  author: 'Daniel Joffe',
