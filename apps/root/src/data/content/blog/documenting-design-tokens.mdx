export const metadata = {
  ...
  date: '2026-04-05',
  excerpt:
    'A comprehensive theme token reference is part of the design system, not an afterthought. Here is how we document 100+ tokens for a Tailwind CSS 4 component library.',
  author: 'Daniel Joffe',
