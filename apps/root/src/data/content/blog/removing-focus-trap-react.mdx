export const metadata = {
  ...
  date: '2026-04-05',
  excerpt:
    'Why removing a 15KB dependency from our shared-ui library and replacing it with native dialog behavior and manual focus management improves bundle size and maintainability.',
  author: 'Daniel Joffe',
