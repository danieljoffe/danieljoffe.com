export const metadata = {
  ...
  cover: {
    ...
    src: '/images/covers/mobile-bottom-nav-z-index.webp',
  },
};
...
The fix needed a deliberate stacking order, not just "make it higher." I
...
`bottom-20` (5rem) clears the `h-14` (3.5rem) nav bar with some breathing
