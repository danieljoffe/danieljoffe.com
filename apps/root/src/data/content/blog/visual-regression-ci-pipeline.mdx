export const metadata = {
  ...
  author: 'Daniel Joffe',
  category: 'Tooling & CI',
  tags: ['GitHub Actions', 'Playwright', 'Visual Regression', 'CI/CD', 'E2E Testing'],
  ...
  cover: {
    ...
    origin: 'https://unsplash.com/photos/black-and-silver-laptop-computer-on-table-4hbJ-eymZ1o',
    creator: '@luca_bravo',
  },
};
