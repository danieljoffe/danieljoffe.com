export const metadata = {
  ...
  date: '2026-04-04',
  excerpt:
    'How a CI pipeline catches visual regressions with Playwright screenshots, auto-updates baselines via workflow dispatch, and re-triggers itself using a PAT. Snapshot maintenance becomes a one-click operation.',
  author: 'Daniel Joffe',
  category: 'DevOps',
  tags: [
    'GitHub Actions',
