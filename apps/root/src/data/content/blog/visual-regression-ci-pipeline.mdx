export const metadata = {
  ...
  date: '2026-04-04',
  excerpt:
    'How I built a CI pipeline that catches visual regressions with Playwright screenshots, auto-updates baselines via workflow dispatch, and re-triggers itself using a PAT — turning snapshot maintenance from a chore into a one-click operation.',
  author: 'Daniel Joffe',
  category: 'DevOps',
  tags: [
    'GitHub Actions',
