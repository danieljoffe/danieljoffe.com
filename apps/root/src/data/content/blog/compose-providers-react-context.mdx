export const metadata = {
  ...
  tags: ['React', 'Context API', 'TypeScript', 'State Management', 'Performance', 'Design Patterns'],
  ...
  cover: {
    ...
    origin: 'https://unsplash.com/photos/multicolored-abstract-painting-bU6JyhSI6zo',
