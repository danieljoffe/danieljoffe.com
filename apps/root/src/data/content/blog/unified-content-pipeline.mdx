export const metadata = {
  ...
  date: '2026-04-03',
  excerpt:
    'How I refactored a portfolio site from duplicated per-type data files to a single content registry, cutting the cost of adding new content types from 6+ files to 3.',
  author: 'Daniel Joffe',
  category: 'Architecture',
  tags: ['Next.js', 'MDX', 'TypeScript', 'Content Architecture'],
...
const contentTypeConfigs = {
  ...
  experience: { basePath: '/experience', label: 'Experience', contentDir: 'experience' },
