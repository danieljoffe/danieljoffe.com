export const metadata = {
  ...
  date: '2026-04-15',
  excerpt:
    'Built a six-provider job-search pipeline: Python/FastAPI scraper, weighted scoring, Next.js admin dashboard, JWT-cookie auth, auto-detect ATS, and 8-second scans.',
  author: 'Daniel Joffe',
