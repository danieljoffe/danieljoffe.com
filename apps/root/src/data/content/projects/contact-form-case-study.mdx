...
export const metadata = {
  ...
  tags: ['Next.js', 'React Hook Form', 'Yup', 'hCaptcha', 'Rate Limiting', 'Security', 'API Routes', 'Resend'],
  ...
  cover: {
    ...
    origin: 'https://unsplash.com/photos/black-iphone-5-on-yellow-textile-DoWZMPZ-M9s',
