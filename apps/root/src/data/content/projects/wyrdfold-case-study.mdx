export const metadata = {
  ...
  date: '2026-05-02',
  excerpt:
    'A full-stack job-search platform: Next.js BFF, FastAPI matching service, Supabase, and a two-phase LLM pipeline with versioned prompt caching and cost guardrails.',
  author: 'Daniel Joffe',
