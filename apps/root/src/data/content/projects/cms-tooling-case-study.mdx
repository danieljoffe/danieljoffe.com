export const metadata = {
  ...
  author: 'Daniel Joffe',
  category: 'Tooling & CI',
  tags: ['Angular', 'Node.js', 'CMS', 'E-commerce', 'Self-Serve Tooling', 'Marketing Automation', 'S3', 'Express'],
  ...
  cover: {
    ...
    origin: 'https://unsplash.com/photos/an-open-book-on-a-lit-desk-wrHIcAR0AWc',
