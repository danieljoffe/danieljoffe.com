// Internal named handles used only to build blogPageSlugs below. Display order
// of posts now lives in each MDX's `order` metadata field; this array's order
// backs AllowedBlogSlugs, the About list, and structured-data ItemLists.
const blogSlugs = {
